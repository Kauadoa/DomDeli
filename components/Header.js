...
import { DarkModeContext } from "./DarkModeContext"; // Importa o contexto do Dark Mode
...
export default function Header() {
  ...
  const [menuOpen, setMenuOpen] = useState(false); // Estado para controlar o menu cascata
  ...
  return (
    <header className={`p-5 w-full flex justify-between items-center border-b 
      ...
      {/* Botão de configurações com menu cascata */}
      <div className="relative">
        <button onClick={toggleMenu} className="cursor-pointer flex flex-col items-center ml-4">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 1.5c5.25 0 9.75 4.5 9.75 9.75 0 2.25-.75 4.5-2.25 6.75L21 21c.75 1.5-1.5 3.75-3 3-2.25-1.5-4.5-3-6.75-3S7.5 22.5 5.25 24c-1.5.75-3.75-1.5-3-3L3.75 18c-1.5-2.25-2.25-4.5-2.25-6.75 0-5.25 4.5-9.75 9.75-9.75z" />
          </svg>
